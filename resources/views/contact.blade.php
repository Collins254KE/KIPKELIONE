    ...
    <div class="row justify-content-between">
        ...
        <div class="col-12 col-lg-6">
            <div class="contact-info">
                ...
                <ul class="p-0 m-0">
                    <li><span>Location:</span>Kipkelion East , Kipkelion East, Londiani,Kericho Kenya</li>
                    <li><span>Email:</span><a href="#">enquiries@kipkelioneast.com</a></li>
                    <li><span>Phone:</span><a href="#">(254) 123-40066</a></li>
                </ul>
            </div><!-- .contact-info -->
        </div><!-- .col -->
    </div><!-- .row -->
