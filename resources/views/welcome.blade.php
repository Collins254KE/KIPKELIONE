            ...
            <div class="row">
                <div class="col-12 col-lg-6 align-content-lg-stretch">
                    <header class="heading">
                        ...
                        <p>Kipkelion East Constituency is committed to provide scholarships and bursaries to deserving students in the sub-county. The Scholarships are available to Secondary school, College and University students in the sub-county.</p>
                    </header><!-- .heading -->
                    ...
                    <header class="heading">
                        ...
                        <p>
                            For one to qualify for the scholarships and bursaries for Kipkelion East sub-county, must be of the following:

                            <ul class="p-0 m-0 green-ticked">
                                <li>Applicant must be residents of Kipkelion East.</li>
                ...
                <div class="step">
                    ...
                    <div class="stepDescription">
                        ...
                        <span>You will receive an email notification when your bursary/scholarship application is approved.
                            You can then pick the awarded bursary/scholarship cheque from sub-county offices or have it sent to the school directly.
                        </span>
                    </div>
                </div>
            </div>
