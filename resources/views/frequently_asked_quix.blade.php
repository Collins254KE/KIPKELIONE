                        ...
                        <div class="card">
                            ...
                            <div class="card card-body collapse" id="demo6">
                                ...
                                <ul class="p-0 m-0 green-ticked">
                                    <li>Needy students within the sub-county?</li>
                                    <li>Needy Student learning in different institutions outside the county but are residents of Kipkelion East sub-county.</li>
                    ...
                    <li>
                        ...
                        <div class="card" style="margin-top: 5%;">
                            ...
                            <div class="card card-body collapse" id="demo7">
                                ...
                                Kipkelion East will make announcements of when students can start apply for scholarship or sub-county bursaries. Always check on the sub-county. Kipkelion East website.
                    ...
                    <li>
                        ...
                        <div class="card" style="margin-top: 5%;">
                            ...
                            <div class="card card-body collapse" id="demo8">
                                ...
                                You will receive an email notification when your bursary/scholarship application is approved. You can then pick the awarded bursary/scholarship cheque from sub-county offices or have it sent to the school directly.
