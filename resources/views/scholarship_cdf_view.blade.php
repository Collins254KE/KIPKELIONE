...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <th>Father ID</th>
            <td>{{ $application->father_id ?? 'N/A' }}</td>
        </tr>

        <tr>
            <th>Father Phone</th>
            <td>{{ $application->father_phone ?? 'N/A' }}</td>
        </tr>
        ...
        <tr>
            <th>Mother ID</th>
            <td>{{ $application->mother_id ?? 'N/A' }}</td>
        </tr>

        <tr>
            <th>Mother Phone</th>
            <td>{{ $application->mother_phone ?? 'N/A' }}</td>
        </tr>
        ...
        <tr>
            ...
            <td>
                <a href="{{ asset('storage/' . $application->principal_letter) }}" 
                   target="_blank" 
